...
public class Settings {
    ...
    // Calidad streaming
    public static final int QUALITY_32 = 32;
    ...
    public static final String[] QUALITY_LABELS = {"32 kbps", "64 kbps", "128 kbps"};
    public static final int[] QUALITY_VALUES = {32, 64, 128};
    ...
    private void parse(String s) {
        try {
            ...
            quality = parseInt(s.substring(pipes[3] + 1, pipes[4]));
    ...
    /** Obtiene el indice de calidad actual en el array QUALITY_VALUES */
    public int getQualityIndex() {
        for (int i = 0; i < QUALITY_VALUES.length; i++) {
            if (QUALITY_VALUES[i] == quality) return i;
        }
        return 1; // default 64
    }

    /** Establece calidad por indice */
    public void setQualityByIndex(int idx) {
        if (idx >= 0 && idx < QUALITY_VALUES.length) {
